...
namespace TestProject
{
	...
	public:
		...
		TEST_METHOD(equalFields)
		{
			...
			Assert::AreEqual(true, GameFieldData::compareFields(firstField, secondField));
		}
		...
		TEST_METHOD(heightDifferentFields)
		{
			...
			Assert::AreEqual(false, GameFieldData::compareFields(firstField, secondField));
		}
